...
public class StaticInnerClassSingleton {
     ...
     * 它跟第 3 种方式(双重加锁 DoubleCheckedLockingLazySingleton.class)不同的是：
     * 第 3 种方式只要 Singleton 类被装载了，
    ...
    public static StaticInnerClassSingleton getInstance() {
        return InnerSingletonHolder.staticInnerClassSingleton;
    }
